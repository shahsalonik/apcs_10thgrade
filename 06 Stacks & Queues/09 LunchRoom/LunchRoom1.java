...
{
   protected int grade, arrival, wait;
...
class Freshman extends Customer {
   ...
   private static int totalFreshmanWaitTime, totalFreshmen, longestWaitTime; 
   
   public Freshman(int a, int w) {
      super(a, 1, w, "Fr");
      totalFreshmen++;
   } 
   
   public static int getTotalWait() {
      return totalFreshmanWaitTime;
   }
   
   public static int getTotalFreshmen() {
      return totalFreshmen;
   }  
...
class Sophomore extends Customer {
   ...
   private static int totalSophomoreTime, totalSophomore, longestWaitTime;
   
   public Sophomore(int a, int w) {
      super(a, 2, w, "So");
      totalSophomore++;
   } 
   
   public static int getTotalWait() {
      return totalSophomoreTime;
   }
   
   public static int getTotalSophomore() {
      return totalSophomore;
   } 
...
class Junior extends Customer {
   ...
   private static int totalJuniorTime, totalJunior, longestWaitTime;
   
   public Junior(int a, int w) {
      super(a, 3, w, "Ju");
      totalJunior++;
   } 
   
   public static int getTotalWait() {
      return totalJuniorWaitTime;
   }
   
   public static int getTotalJunior() {
      return totalJunior;
   }
...
class Senior extends Customer {
   ...
   private static int totalSeniorTime, totalSenior, longestWaitTime;
   
   public Senior(int a, int w) {
      super(a, 4, w, "Se");
      totalSenior++;
   } 

   public static int getTotalWait() {
      return totalSeniorTime;
   }
   
   public static int getTotalSenior() {
      return totalSenior;
   } 
